...
# 5. hash:
 ...
 #  The hash option allows you to specify whether a field should be considered when calculating the hash value of the object.

 # Field - [ field(hash=Treu) ] 
  # this is the Field which can be used to specify hash inside the Class.
...
instance_HashClass_1 = HashClass(11, 12)

print( instance_HashClass_1 )
...
class HashClass_2:
    u: str
    v: int = field(hash=True)
    q: float = field(hash=False)


instance_HashClass_2 = HashClass_2("string", 55, 4.9)

print(instance_HashClass_2 )

# Output :-
 # HashClass_2(u='string', v=55, q=4.9)
